    ...
    <div className="relative w-[94%] ml-[5rem]">
      ...
      <div className="flex items-center ml-4 mt-[2rem]">
        ...
        <div className="ml-4 mt-4">
          ...
          <p className="mt-2 ml-[2]">1M Views</p>
          <p className="mt-2 ml-[2]">
            This is a short description. It gives an overview of content and
            what viewers can expect.
          </p>

          <button className="mt-4 bg-red-600 text-white py-2 px-4 rounded hover:background-red-500">
            Subscribe
          </button>
        </div>
      </div>
